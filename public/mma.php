...
<body>
    ...
    $sent = $pdo->prepare('SELECT * from articulos WHERE su_juguete = :id ORDER BY id DESC');
    $sent->execute([':id' => $id]);
    ?>
                ...
                <tbody>
                    <?php foreach ($sent as $fila) : ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="modificar.php?id=<?= $fila['id'] ?> &micodigo=<?= $fila['codigo'] ?> &midescripcion=<?= $fila['descripcion'] ?> &miprecio=<?= $fila['precio'] ?>" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Editar</a>
                            <a href="añadir.php" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Añadir articulo</a>
                            </td>
                        </tr>
                    <?php endforeach ?>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
